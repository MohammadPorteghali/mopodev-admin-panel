    ...
    <v-app-bar app flat>
      ...
      <v-toolbar-title class="headline text-uppercase">
        <div v-resize-text>
          ...
          <router-link :to="{ name: 'landing' }" tag="span" style="cursor: pointer" v-else></router-link>
        </div>
      </v-toolbar-title>
      <v-spacer></v-spacer>
      <v-toolbar-items>
        ...
        <v-btn v-if="$vuetify.breakpoint.lg || $vuetify.breakpoint.xl" text small to="/dashboard">
          <v-icon>dashboard</v-icon>
        </v-btn>
        <v-menu
          v-if="$vuetify.breakpoint.lg || $vuetify.breakpoint.xl"
